...
import cn.com.evo.cms.domain.vo.activity.DrawQueryVo;
...
@Controller
@RequestMapping("activity/drawQuery")
public class DrawQueryController extends BaseController {
    private static final String VIEW_PAGE = "cms/activity/drawQuery/view";
    private static final String FORM_PAGE = "cms/activity/drawQuery/form";
    ...
    protected DrawQueryService getService() {
        return drawQueryService;
    }

    @RequiresPermissions(value = {"Activity:DrawQuery:show"})
    @RequestMapping(value = "", method = {RequestMethod.GET})
    public ModelAndView show(HttpServletRequest request) {
        return new ModelAndView(VIEW_PAGE);
    }

    @RequiresPermissions(value = {"Activity:DrawQuery:search"})
    @RequestMapping(value = "/list", method = {RequestMethod.POST}, produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public DataResult list(HttpServletRequest request, Pager webPage) {
        DataResult dataRet = new DataResult();
        try {
            Specification<DrawQuery> specification = DynamicSpecifications.bySearchFilter(request, DrawQuery.class, null);
            List<DrawQuery> entities = getService().findByCondition(specification, webPage);
            List<DrawQueryVo> lstVo = Lists.newArrayList();
            for (DrawQuery entity : entities) {
                DrawQueryVo vo = mapper.map(entity, DrawQueryVo.class);
                String drawChildName = drawChildService.findById(entity.getDrawChildId()).getName();
                vo.setDrawChildName(drawChildName);
                lstVo.add(vo);
            }
    ...
    @RequiresPermissions(value = {"Activity:DrawQuery:add"})
    @RequestMapping(value = "/add", method = {RequestMethod.POST}, produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public MsgResult store(DrawQuery entity) {
    ...
    public ModelAndView edit(@PathVariable("id") String id) {
        ModelAndView mav = new ModelAndView(FORM_PAGE);
        DrawQuery entity = getService().findById(id);
        mav.addObject("entity", entity);
        return mav;
    }

    @RunLogger(value = "编辑", isSaveRequest = true)
    @RequiresPermissions(value = {"Activity:DrawQuery:modify"})
    @RequestMapping(value = "/edit", method = {RequestMethod.POST}, produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public MsgResult modify(DrawQuery entity) {
        MsgResult msgRet = new MsgResult();
        try {
    ...
    @RequiresPermissions(value = {"Activity:DrawQuery:remove"})

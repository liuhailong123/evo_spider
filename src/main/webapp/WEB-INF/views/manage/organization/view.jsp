...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	var ajaxListUrl = contextPath + '/manage/organization/list';
	var ajaxTreeUrl = contextPath + '/manage/organization/tree';
	var ajaxAddUrl = contextPath + '/manage/organization/add';
	var ajaxEdtUrl = contextPath + '/manage/organization/edit';
	var ajaxDelUrl = contextPath + '/manage/organization/remove';
	var ajaxAssignUrl = contextPath + '/manage/organization/assign';

...
public class IngestAssetService_ServiceLocator extends org.apache.axis.client.Service implements cn.com.evo.integration.xjTvos.content.wb.IngestAssetService_Service {

    public IngestAssetService_ServiceLocator() {
        IngestAssetServiceSOAP_address = ConstantFactory.map.get(XJConstantEnum.ctms_url.getKey());
    ...
    private java.lang.String IngestAssetServiceSOAP_address = "";
    ...
    public cn.com.evo.integration.xjTvos.content.wb.IngestAssetService_PortType getIngestAssetServiceSOAP() throws javax.xml.rpc.ServiceException {
    ...
    public cn.com.evo.integration.xjTvos.content.wb.IngestAssetService_PortType getIngestAssetServiceSOAP(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.evo.integration.xjTvos.content.wb.IngestAssetServiceSOAPStub _stub = new cn.com.evo.integration.xjTvos.content.wb.IngestAssetServiceSOAPStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.com.evo.integration.xjTvos.content.wb.IngestAssetService_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.evo.integration.xjTvos.content.wb.IngestAssetServiceSOAPStub _stub = new cn.com.evo.integration.xjTvos.content.wb.IngestAssetServiceSOAPStub(new java.net.URL(IngestAssetServiceSOAP_address), this);
                _stub.setPortName(getIngestAssetServiceSOAPWSDDServiceName());
                return _stub;
            }
        }

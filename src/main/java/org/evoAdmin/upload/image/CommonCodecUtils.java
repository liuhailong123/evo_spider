...
public class CommonCodecUtils {
    ...
    public static String Base64Encode(byte[] binaryData) {
        ...
        String encodedstr = new String(Base64.encodeBase64(binaryData, false), Charsets.toCharset("UTF-8"));
        return encodedstr;
    }
    ...
    public static String getSlicePartSha1(String localPath, int sliceSize,
        ...
        try {
            ...
            System.out.println("getSlicePartSha1 occur a error, filePath:"+localPath+", sliceSize:"+sliceSize+", exception:"+e.toString());
            throw e;
        } finally {

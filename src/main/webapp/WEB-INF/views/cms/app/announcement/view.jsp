...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	var ajaxListUrl = contextPath + '/app/announcement/list';
	var ajaxAddUrl = contextPath + '/app/announcement/add';
	var ajaxEdtUrl = contextPath + '/app/announcement/edit';
	var ajaxDelUrl = contextPath + '/app/announcement/remove';

    <x:dictData dictCode="AnnouncementType" var="announcementType">
    <x:jsonArray varName="announcementType" keyName="code" valName="name" items="${announcementType}" ></x:jsonArray>
    </x:dictData>
	...
	var columns = [ {
        ...
        formatter: function (value, row, index) {
            var show = value;
            $.each(announcementType, function () {
                if (this.code == value) {
                    show = this.name;
                }
            });

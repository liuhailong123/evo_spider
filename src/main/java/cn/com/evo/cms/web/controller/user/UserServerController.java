...
@Controller
@RequestMapping("/user/userServer")
public class UserServerController extends BaseController {
    private static final String VIEW_PAGE = "cms/user/userServer/view";
    private static final String FORM_PAGE = "cms/user/userServer/form";
    ...
    protected UserServerService getService() {
        return userServerService;
    }

    @RequiresPermissions(value = {"User:UserServer:show"})
    @RequestMapping(value = "", method = {RequestMethod.GET})
    public ModelAndView show(HttpServletRequest request) {
        return new ModelAndView(VIEW_PAGE);
    }

    @RequiresPermissions(value = {"User:UserServer:search"})
    @RequestMapping(value = "/list", method = {RequestMethod.POST}, produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public DataResult list(HttpServletRequest request, Pager webPage) {
        DataResult dataRet = new DataResult();
        try {
            UserServerSearchVo userServerSearchVo = new UserServerSearchVo(request);

            List<UserServerVo> lstVo = userServerService.findByPage(webPage, userServerSearchVo);
    ...
    @RequiresPermissions(value = {"User:UserServer:add"})
    @RequestMapping(value = "/add", method = {RequestMethod.POST}, produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public MsgResult store(UserServer entity) {
    ...
    public ModelAndView edit(@PathVariable("id") String id) {
        ModelAndView mav = new ModelAndView(FORM_PAGE);
        UserServer entity = getService().findById(id);
        mav.addObject("entity", entity);
        return mav;
    }

    @RunLogger(value = "编辑", isSaveRequest = true)
    @RequiresPermissions(value = {"User:UserServer:modify"})
    @RequestMapping(value = "/edit", method = {RequestMethod.POST}, produces = {MediaType.APPLICATION_JSON_VALUE})
    @ResponseBody
    public MsgResult modify(UserServer entity) {
        MsgResult msgRet = new MsgResult();
        try {
    ...
    @RequiresPermissions(value = {"User:UserServer:remove"})

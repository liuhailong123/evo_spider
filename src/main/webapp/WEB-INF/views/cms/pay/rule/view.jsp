...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	...
	var ajaxAddUrl = contextPath + '/pay/rule/add';
	var ajaxEdtUrl = contextPath + '/pay/rule/edit';
	var ajaxDelUrl = contextPath + '/pay/rule/remove';

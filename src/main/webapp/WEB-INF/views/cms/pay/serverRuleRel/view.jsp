...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	...
	var ajaxAddUrl = contextPath + '/pay/serverRuleRel/add';
	var ajaxEdtUrl = contextPath + '/pay/serverRuleRel/edit';
	var ajaxDelUrl = contextPath + '/pay/serverRuleRel/remove';

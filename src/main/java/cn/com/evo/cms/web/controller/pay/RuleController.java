...
import cn.com.evo.cms.domain.vo.pay.RuleVo;
...
public class RuleController extends BaseController {
	private static final String VIEW_PAGE = "cms/pay/rule/view";
	private static final String FORM_PAGE = "cms/pay/rule/form";
	private static final String SELECT_PAGE = "cms/pay/rule/select";
	...
	@RequiresPermissions(value = { "ProductCharge:Prod:Rule:show" })
	@RequestMapping(value = "", method = { RequestMethod.GET })
	public ModelAndView show(HttpServletRequest request) {
		return new ModelAndView(VIEW_PAGE);
	}

	@RequiresPermissions(value = { "ProductCharge:Prod:Rule:search" })
	@RequestMapping(value = "/list", method = { RequestMethod.POST }, produces = { MediaType.APPLICATION_JSON_VALUE })
	@ResponseBody
	public DataResult list(HttpServletRequest request, Pager webPage) {
		DataResult dataRet = new DataResult();
		try {
			Specification<Rule> specification = DynamicSpecifications.bySearchFilter(request, Rule.class,null);
			List<Rule> entities = getService().findByCondition(specification, webPage);
			List<RuleVo> lstVo = Lists.newArrayList();
			for (Rule entity : entities) {
				RuleVo vo = mapper.map(entity, RuleVo.class);
				lstVo.add(vo);
			}
	...
	@RequiresPermissions(value = { "ProductCharge:Prod:Rule:add" })
	@RequestMapping(value = "/add", method = { RequestMethod.POST }, produces = { MediaType.APPLICATION_JSON_VALUE })
	@ResponseBody
	public MsgResult store(Rule entity) {
	...
	public ModelAndView edit(@PathVariable("id") String id) {
		ModelAndView mav = new ModelAndView(FORM_PAGE);
		Rule entity = getService().findById(id);
		mav.addObject("entity", entity);
		return mav;
	}

	@RunLogger(value = "编辑", isSaveRequest = true)
	@RequiresPermissions(value = { "ProductCharge:Prod:Rule:modify" })
	@RequestMapping(value = "/edit", method = { RequestMethod.POST }, produces = { MediaType.APPLICATION_JSON_VALUE })
	@ResponseBody
	public MsgResult modify(Rule entity) {
		MsgResult msgRet = new MsgResult();
		try {
	...
	@RequiresPermissions(value = { "ProductCharge:Prod:Rule:remove" })

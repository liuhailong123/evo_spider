...
import cn.com.evo.cms.domain.vo.activity.DrawVo;
...
public class DrawController extends BaseController {
    private static final String VIEW_PAGE = "cms/activity/draw/view";
    private static final String FORM_PAGE = "cms/activity/draw/form";
    ...
    protected DrawService getService() {
        return drawService;
    }
    ...
    public DataResult list(HttpServletRequest request, Pager webPage) {
        ...
        try {
            Specification<Draw> specification = DynamicSpecifications.bySearchFilter(request, Draw.class, null);
            List<Draw> entities = getService().findByCondition(specification, webPage);
            List<DrawVo> lstVo = Lists.newArrayList();
            for (Draw entity : entities) {
                DrawVo vo = mapper.map(entity, DrawVo.class);
                lstVo.add(vo);
            }
    ...
    @ResponseBody
    public MsgResult store(Draw entity) {
    ...
    public ModelAndView edit(@PathVariable("id") String id) {
        ModelAndView mav = new ModelAndView(FORM_PAGE);
        Draw entity = getService().findById(id);
    ...
    @ResponseBody
    public MsgResult modify(Draw entity) {
        MsgResult msgRet = new MsgResult();
        try {

...
<form name="assignAccountRoles" id="assignAccountRoles" target="_self"  class="form-inline searchCondition">
...
//撤销
function doUnAssign(AccountRoleId){
	var url = "${contextPath}/manage/account/revoke";
	var params={
			'id': AccountRoleId
	};
...
function doAssign(roleId){
	var url = "${contextPath}/manage/account/assign";
	var params={
...
jQuery(function($){
	var ajaxAssignedListUrl = contextPath + "/manage/account/assigned";
	var assignedColumns = [
	...
	var ajaxUnAssignListUrl = contextPath + "/manage/account/unAssigned";
	var unassignColumns = [
	...
	initTable('table-assigned', assignedColumns, ajaxAssignedListUrl, 'assignAccountRoles');
	initTable('table-unAssign', unassignColumns, ajaxUnAssignListUrl, 'assignAccountRoles');
})
</script>
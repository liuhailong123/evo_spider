...
jQuery(function($) {
	...
	function enableAjax() {		
		...
		var ajax_options = {
			 ...
			 'default_url': 'page/manage/home',//default hash
			 'content_url': function(hash) {
				...
				//hide hash path value
				//var module = hash.split("/")[1];
				//var urlPath = document.location.pathname;
				//var regexp = /^page\/\S*\//;
				//document.location.pathname = urlPath + "#" + hash.replace(regexp, '');
				//request real path.
				var path = contextPath + "/" + hash.replace(/^page\//, '');

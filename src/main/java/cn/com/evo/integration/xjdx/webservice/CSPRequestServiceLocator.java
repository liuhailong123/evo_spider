...
package cn.com.evo.integration.xjdx.webservice;

import cn.com.evo.integration.chongqing.common.CQConstantEnum;
import cn.com.evo.integration.common.ConstantFactory;

public class CSPRequestServiceLocator extends org.apache.axis.client.Service implements cn.com.evo.integration.xjdx.webservice.CSPRequestService {
    ...
    public cn.com.evo.integration.xjdx.webservice.CSPRequest getctms() throws javax.xml.rpc.ServiceException {
    ...
    public cn.com.evo.integration.xjdx.webservice.CSPRequest getctms(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.evo.integration.xjdx.webservice.CtmsSoapBindingStub _stub = new cn.com.evo.integration.xjdx.webservice.CtmsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.com.evo.integration.xjdx.webservice.CSPRequest.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.evo.integration.xjdx.webservice.CtmsSoapBindingStub _stub = new cn.com.evo.integration.xjdx.webservice.CtmsSoapBindingStub(new java.net.URL(ctms_address), this);
                _stub.setPortName(getctmsWSDDServiceName());
                return _stub;
            }
        }

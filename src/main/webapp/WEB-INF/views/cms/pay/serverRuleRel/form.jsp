	...
	<div class="col-lg-12">
		<form id="formDlg" class="form-horizontal" role="form" enctype="multipart/form-data" method="post">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input type="hidden" id="serverId" name="server.id" value="${entity.server.id}" />
					<input type="text" class="form-control" id="serverName" name="server.name" value="${entity.server.name}" readonly="readonly"/>
				</div>
				<div class="col-lg-2">
			...
			<div class="form-group">
				...
				<div class="col-lg-6">
					<input type="hidden" id="ruleId" name="rule.id" value="${entity.rule.id}" />
					<input type="text" class="form-control" id="ruleName" name="rule.name" value="${entity.rule.name}" readonly="readonly"/>
				</div>
				<div class="col-lg-2">

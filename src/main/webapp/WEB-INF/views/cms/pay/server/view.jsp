...
$('.page-content-area').ace_ajax('loadScripts', scripts, function() {
	var ajaxListUrl = contextPath + '/pay/server/list';
	var ajaxAddUrl = contextPath + '/pay/server/add';
	var ajaxEdtUrl = contextPath + '/pay/server/edit';
	var ajaxDelUrl = contextPath + '/pay/server/remove';

...
public final class UploadUtil {
    ...
    /** 上传文件临时目录 */
    private static final String UPLOAD_FILE_DIR = "/WEB-INF/upload/";
    ...
    public static List<String> uploadImage(HttpServletRequest request) {
        ...
        if (multipartResolver.isMultipart(request)) {
            ...
            String pathDir = request.getSession().getServletContext().getRealPath(UPLOAD_FILE_DIR + DateUtil.getDate());
    ...
    public static String getUploadDir(HttpServletRequest request) {
        return request.getServletContext().getRealPath(UPLOAD_FILE_DIR) + File.separator;
    }
}

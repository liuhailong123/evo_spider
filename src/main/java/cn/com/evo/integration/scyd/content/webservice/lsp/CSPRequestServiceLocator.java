...
public class CSPRequestServiceLocator extends org.apache.axis.client.Service implements cn.com.evo.integration.scyd.content.webservice.lsp.CSPRequestService {
...
//    private java.lang.String ctms_address = "http://223.87.2.143:8184/lcms-api/services/ctms";
    private java.lang.String ctms_address = "http://183.222.171.15:8082/lcms-api/services/ctms";
    ...
    public cn.com.evo.integration.scyd.content.webservice.lsp.CSPRequest getctms(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            cn.com.evo.integration.scyd.content.webservice.lsp.CtmsSoapBindingStub _stub = new cn.com.evo.integration.scyd.content.webservice.lsp.CtmsSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (cn.com.evo.integration.scyd.content.webservice.lsp.CSPRequest.class.isAssignableFrom(serviceEndpointInterface)) {
                cn.com.evo.integration.scyd.content.webservice.lsp.CtmsSoapBindingStub _stub = new cn.com.evo.integration.scyd.content.webservice.lsp.CtmsSoapBindingStub(new java.net.URL(ctms_address), this);
                _stub.setPortName(getctmsWSDDServiceName());
                return _stub;
            }
